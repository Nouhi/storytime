...
export const LANGUAGES: Language[] = [
  { id: "en", label: "English", emoji: "🇺🇸", nativeName: "English" },
  { id: "es", label: "Spanish", emoji: "🇪🇸", nativeName: "Español" },
  { id: "fr", label: "French", emoji: "🇫🇷", nativeName: "Français" },
  { id: "ar", label: "Arabic", emoji: "🇸🇦", nativeName: "العربية" },
  { id: "de", label: "German", emoji: "🇩🇪", nativeName: "Deutsch" },
  { id: "zh", label: "Chinese", emoji: "🇨🇳", nativeName: "中文" },
  { id: "pt", label: "Portuguese", emoji: "🇧🇷", nativeName: "Português" },
  { id: "hi", label: "Hindi", emoji: "🇮🇳", nativeName: "हिन्दी" },
  { id: "ja", label: "Japanese", emoji: "🇯🇵", nativeName: "日本語" },
  { id: "ko", label: "Korean", emoji: "🇰🇷", nativeName: "한국어" },
  { id: "it", label: "Italian", emoji: "🇮🇹", nativeName: "Italiano" },
  { id: "nl", label: "Dutch", emoji: "🇳🇱", nativeName: "Nederlands" },
  { id: "ru", label: "Russian", emoji: "🇷🇺", nativeName: "Русский" },
  { id: "tr", label: "Turkish", emoji: "🇹🇷", nativeName: "Türkçe" },
];
