...
3. The first time you open the app, macOS will block it (the app isn't signed). Go to **System Settings → Privacy & Security**, scroll down, and click **Open Anyway**. You only need to do this once. (This is because I did not want to pay the $99 to sign up for an Apple Developer Account and as a result the app is not signed)
<img width="471" height="98" alt="image" src="https://github.com/user-attachments/assets/304464f9-ab74-4be5-ad9c-d2cda974ef2f" />
...
5. Type a prompt describing tonight's adventure
6. Pick a writing style and image style (or "No Images" for text-only)
7. Download the PDF, EPUB or scan the QR code to open directly in Apple Books
